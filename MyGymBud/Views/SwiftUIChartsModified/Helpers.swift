...
public struct Colors {
    ...
    public static let IndicatorKnob:Color = Color("AccentColorOpposite")
...
public struct Styles {
    public static let MGBLineChartStyle = ChartStyle(
        backgroundColor: Color("Background"),
        accentColor: Color("AccentColor"),
        secondGradientColor: Color("AccentColor-GradientEnd"),
        textColor: Color("Foreground"),
        legendTextColor: Color("AccentColorOpposite"),
        dropShadowColor: Color("AccentColorOpposite"))
